# WEB应用软件开发实例 - 第三次作业 - Git 使用
>learngit 项目网址为：https://wubin-o.github.io/learngit/
## 一.必做部分
### 1.安装 Git
...
### 3.版本控制
![tree](https://wubin-o.github.io/learngit/24.png)
### 4.版本回退
...
## 三.实验过程
安装git ，建立一个readme.txt的文件夹，根据以里的命令操作，git add ,git commit -m分别上传到暂存区和工作区，然后就是使用密钥将本地仓库与github仓库相连
## 四.总结
总体这个实验不这么难，根据老师所发讲义的步骤去做很快就能做好，但还是存在一些的问题，例如密钥连接，根据讲义里的指令怎么都连不上，上网搜索后，还是决定用https的协议去连。
